...
export default function GalleryVariantPage() {
      ...
      <section className="relative min-h-screen overflow-hidden py-20">
        <div className="relative z-10">
          ...
          >
              ...
              >
                {galleryImages.map((image, i) => {
                  ...
                  return (
                    <motion.div
                      key={`gallery-${i}`}
                      className="magazine-frame magazine-frame-hover group relative cursor-pointer overflow-hidden"
                      style={{
                        gridRow: span.row,
                        gridColumn: span.col,
                      }}
                    ...
                    >
                      {/* Ambient glow effect */}
                      <motion.div
                        className="absolute -inset-4 -z-10 rounded-xl opacity-0 group-hover:opacity-100"
                        style={{
            ...
            {/* Info text */}
            <p className="mt-12 text-center text-sm font-light uppercase tracking-widest text-amber-500/70">
